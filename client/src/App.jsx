                ...
                <header className="fixed top-0 left-0 w-full bg-slate-900/80 backdrop-blur-sm z-50">
                    <div className="container mx-auto px-6 py-4 flex justify-between items-center">
                        ...
                        <div className="flex items-center">
                            <a href="/login" className="hidden sm:inline-block bg-gradient-to-r from-violet-600 to-indigo-600 text-white font-semibold px-6 py-2 rounded-lg hover:shadow-lg hover:shadow-violet-500/20 transition-shadow">
                                Login / Sign Up
                            </a>
                    ...
                    {isMenuOpen && (
                        <div className="md:hidden bg-slate-800 py-4">
                            {navLinks.map(link => (
                             ...
                             <a href="/login" className="block text-center py-2 mt-2 mx-6 bg-gradient-to-r from-violet-600 to-indigo-600 text-white font-semibold rounded-lg">
                                Login / Sign Up
                            </a>
                        </div>
                    )}
                ...
                <main>
                    ...
                    <section id="home" className="relative h-screen flex items-center justify-center overflow-hidden">
                        ...
                        <div ref={heroRef} className={`relative z-10 text-center px-6 transition-opacity duration-1000 ease-out ${heroVisible ? 'opacity-100' : 'opacity-0'}`}>
                            ...
                            <a href="/login" className="mt-8 inline-block bg-gradient-to-r from-violet-600 to-indigo-600 text-white font-bold px-8 py-3 rounded-lg text-lg hover:shadow-xl hover:shadow-violet-500/30 transition-shadow transform hover:scale-105">
                                Get Started
                            </a>
                        </div>
                    </section>
